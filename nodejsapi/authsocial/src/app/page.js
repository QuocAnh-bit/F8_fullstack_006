          ...
          <div className="my-3 ">
            ...
            <div className="flex justify-between">
              <div class="inline-flex rounded-md shadow-sm" role="group">
                ...
                >
                  {user && user?.providers.google ? (
                    <div className="flex gap-2 items-center">
                      <div className="rounded-lg overflow-hidden w-fit">
                        <Image
                          src={user?.providers.google.image}
                          width={20}
                          height={20}
                          alt="Avatar"
                        />
                ...
                >
                  {user && user?.providers.github ? (
                    <div className="flex gap-2 items-center">
                      <div className="rounded-lg overflow-hidden w-fit">
                        <Image
                          src={user?.providers.github.image}
                          width={20}
                          height={20}
                          alt="Avatar"
                        />
              ...
              <div>
                <Link href={`http://localhost:3000/api/logout`}>Đăng xuất</Link>
              </div>
            </div>
            <hr className="my-2" />
          </div>
